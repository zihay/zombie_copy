...
template <size_t DIM>
inline float regularizationForGreensFn(float r)
{
    return 1.0f;
}

template <size_t DIM>
inline float regularizationForPoissonKernel(float r)
{
    return 1.0f;
}

template <>
inline float regularizationForGreensFn<3>(float r)
{
...
template <>
inline float regularizationForPoissonKernel<2>(float r)
{
...
template <>
inline float regularizationForPoissonKernel<3>(float r)
{
    // source: https://arxiv.org/pdf/1508.00265.pdf
